...
// Tool Components
import { CdCalculator } from '@/src/tools/CdCalculator';
...
const Dashboard = () => {
  ...
  useEffect(() => {
    document.title = "CD Calculator - Calculate Certificate of Deposit Interest (2026)";
    const metaDescription = document.querySelector('meta[name="description"]');
    const descriptionText = "Use our free CD Calculator to estimate your Certificate of Deposit earnings. Calculate interest, final balance, and APY with precision. Plan your CD ladder today!";
    if (metaDescription) {
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {!searchQuery && (
        <motion.div
          ...
          className="mb-12"
        >
          <div className="bg-white rounded-[2.5rem] border border-zinc-200 shadow-2xl overflow-hidden">
            <div className="p-4 md:p-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h1 className="text-3xl font-bold text-zinc-900">CD Calculator</h1>
                  <p className="text-zinc-500 mt-1">Calculate your Certificate of Deposit earnings instantly.</p>
                </div>
                <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-full text-sm font-medium border border-emerald-100">
                  <Calculator className="w-4 h-4" />
                  <span>Featured Tool</span>
                </div>
              </div>
              <CdCalculator isWidget={true} />
            </div>
          </div>
        </motion.div>
      )}
        ...
        >
          <div className="relative flex-grow">
            ...
            <input
              ref={searchRef}
              type="text"
              placeholder="Search for a tool (e.g., CD, BMI, PDF, Tree...)"
              value={searchQuery}
      ...
      {!searchQuery && (
        <div className="mt-24 space-y-20 max-w-4xl mx-auto">
          ...
          <section className="space-y-12">
            ...
            <div className="p-8 bg-emerald-50 rounded-3xl border border-emerald-100 space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                <button className="px-4 py-2 bg-white border border-emerald-200 rounded-full text-sm text-emerald-700 hover:bg-emerald-100 transition-colors">Compound Interest Calculator</button>
                <button className="px-4 py-2 bg-white border border-emerald-200 rounded-full text-sm text-emerald-700 hover:bg-emerald-100 transition-colors">Savings Goal Calculator</button>
                <button className="px-4 py-2 bg-white border border-emerald-200 rounded-full text-sm text-emerald-700 hover:bg-emerald-100 transition-colors">Loan Amortization Tool</button>
              </div>
            </div>
          ...
          <div className="text-center pt-12 border-t border-zinc-100">
            ...
            <div className="mt-8">
              <button className="px-8 py-4 bg-emerald-600 text-white rounded-2xl font-bold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-200 active:scale-95">
          ...
          <div className="bg-white/40 backdrop-blur-xl border border-white/40 rounded-3xl shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] hover:shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] transition-all duration-500 h-16 flex items-center justify-between px-6 relative overflow-hidden group/header">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/" className="flex items-center gap-2 group">
                ...
                <span className="font-bold text-xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 to-zinc-600">CD Calculator</span>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/40 backdrop-blur-xl border border-white/40 rounded-3xl p-8 flex flex-col md:flex-row justify-between items-center gap-8 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-zinc-900">CD Calculator</span>
      ...
      <SearchProvider>
        ...
        <AppLayout>
          <Routes>
            ...
            <Route path="/cd-calculator" element={<ToolWrapper toolId="cd-calculator"><CdCalculator /></ToolWrapper>} />
