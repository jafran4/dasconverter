...
import { FileText, ArrowLeft, Layout, Download, FileUp } from 'lucide-react';
import { Link } from 'react-router-dom';
import RelatedToCd from '../components/RelatedToCd';

export const PdfOrganizer = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pt-24 pb-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-zinc-900 mb-4">Organize PDF</h1>
        <p className="text-zinc-600 max-w-2xl mx-auto">
          Reorder, delete, or insert pages into your PDF documents.
        </p>
      </div>
      ...
      <div className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-sm">
        <div className="flex flex-col items-center justify-center border-2 border-dashed border-zinc-200 rounded-2xl p-12 hover:border-blue-500/50 transition-colors bg-zinc-50/50">
          ...
          <p className="text-zinc-600 mb-4">Select a PDF file to organize</p>
          <input
            type="file"
            accept=".pdf"
      ...
      <RelatedToCd toolName="PDF Organizer" category="PDF" />
    </div>
  );
};
