  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pt-24 pb-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-zinc-900 mb-4">PDF to PowerPoint</h1>
        <p className="text-zinc-600 max-w-2xl mx-auto">
          Convert your PDF documents into PowerPoint presentations (.pptx).
        </p>
      </div>

      <div className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-sm">
        <div className="flex flex-col items-center justify-center border-2 border-dashed border-zinc-200 rounded-2xl p-12 hover:border-orange-500/50 transition-colors bg-zinc-50/50">
        ...
        <button
          ...
          className="w-full mt-8 py-4 bg-orange-600 text-white rounded-2xl font-bold hover:bg-orange-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
