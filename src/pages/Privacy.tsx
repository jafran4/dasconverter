    ...
    <div className="max-w-4xl mx-auto px-4 py-24">
      ...
      >
        ...
        <p className="text-xl text-zinc-600 leading-relaxed">
          At Das Converter, we take your privacy seriously. Our tools are designed with a "Privacy-First" approach, meaning your data stays where it belongs: with you.
        </p>
      </motion.div>
