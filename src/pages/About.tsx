  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-24">
      ...
      >
        ...
        <h1 className="text-5xl font-bold text-zinc-900 mb-6 tracking-tight">About Das Converter</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
        ...
        >
          ...
          <p className="text-zinc-600 leading-relaxed">
            Whether you're on a desktop, tablet, or smartphone, Das Converter works seamlessly across all your devices.
          </p>
        </motion.div>
